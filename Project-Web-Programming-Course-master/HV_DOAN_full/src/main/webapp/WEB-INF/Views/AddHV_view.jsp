...
<% } %>
        ...
        <%-- Form thêm tài khoản --%>
        <form action="Add_TK_servlet" method="POST">
            <div class="form-group">
        
            <label for="maHocVien">Mã học viên:</label>
            <input type="text" id="maHocVien" name="maHocVien"  value="${maHocVien}" required><br>
</div>
    <div class="form-group">
...
<button class="cancel-button" onclick="window.location.href='${pageContext.request.contextPath}/ADMIN_HV'">
